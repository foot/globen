...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t59751 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t59751 = (function (val,box,meta59752){
this.val = val;
this.box = box;
this.meta59752 = meta59752;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t59751.cljs$lang$type = true;
cljs.core.async.impl.channels.t59751.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t59751";
cljs.core.async.impl.channels.t59751.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t59751");
});
cljs.core.async.impl.channels.t59751.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t59751.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_59753){var self__ = this;
var _59753__$1 = this;return self__.meta59752;
});
cljs.core.async.impl.channels.t59751.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_59753,meta59752__$1){var self__ = this;
var _59753__$1 = this;return (new cljs.core.async.impl.channels.t59751(self__.val,self__.box,meta59752__$1));
});
cljs.core.async.impl.channels.__GT_t59751 = (function __GT_t59751(val__$1,box__$1,meta59752){return (new cljs.core.async.impl.channels.t59751(val__$1,box__$1,meta59752));
});
}
return (new cljs.core.async.impl.channels.t59751(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_59754 = self__.takes.pop();if((taker_59754 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_59754))
{var take_cb_59755 = cljs.core.async.impl.protocols.commit.call(null,taker_59754);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_59755,taker_59754){
return (function (){return take_cb_59755.call(null,null);
});})(take_cb_59755,taker_59754))
);
} else
{}
{
